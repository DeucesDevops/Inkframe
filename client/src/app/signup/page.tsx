        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
            <div className="max-w-md w-full space-y-8 bg-slate-900 p-10 rounded-3xl border border-slate-800 shadow-2xl">
                <div className="text-center">
                    ...
                    <h2 className="mt-6 text-xl font-bold text-white">Create your account</h2>
                    <p className="mt-2 text-sm text-slate-400">Join authors building the future of books</p>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-widest px-1">Password (8+ chars)</label>
                            <input
                                type="password"
                                required
                                minLength={8}
